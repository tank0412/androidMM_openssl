...
# host shared library
include $(CLEAR_VARS)
LOCAL_SHARED_LIBRARIES += libcrypto_openssl-host $(log_shared_libraries)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libssl_openssl-host
LOCAL_MULTILIB := both
LOCAL_ADDITIONAL_DEPENDENCIES := $(LOCAL_PATH)/android-config.mk $(LOCAL_PATH)/Ssl.mk
...
LOCAL_SHARED_LIBRARIES := libssl-openssl libcrypto_openssl $(log_shared_libraries)
LOCAL_MODULE := ssltest_openssl
LOCAL_MULTILIB := both
